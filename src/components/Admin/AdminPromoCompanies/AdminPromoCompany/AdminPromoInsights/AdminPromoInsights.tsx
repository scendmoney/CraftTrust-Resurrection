...
import {
  ...
  IQueryCompanyInsightsAdminArgs
} from 'graphql/_server';
import COMPANY_INSIGHTS_ADMIN from 'graphql/queries/companyInsightsAdmin';
...
import mappingAge from './mappingAge';
import {
  appealingSurvey,
  colorSurvey,
  experienceSurvey,
  ...
  purposeSurvey,
  stoneySurvey
} from './selectEnumOptions';
import styles from './styles';

const AdminPromoInsights: FC = () => {
  ...
  useEffect(() => {
    if (data?.companyInsightsAdmin.items) {
      actions.setRows(data?.companyInsightsAdmin.items);
      actions.setTotal(data.companyInsightsAdmin.meta.total);
    }
  }, [actions, data?.companyInsightsAdmin.items, data?.companyInsightsAdmin.meta.total]);
  ...
  return (
    <Box sx={styles.tableWrapper}>
      ...
      <UniversalTable
        rows={data?.companyInsightsAdmin?.items || []}
...
export default AdminPromoInsights;
