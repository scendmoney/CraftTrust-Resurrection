...
import AdminBuyersInsightsDetails from './AdminBuyersInsightsDetails';
import styles from './styles';

const AdminBuyersInsightsDetailsWrapper: FC<{
  id?: string;
  close: () => Promise<void>;
...
export default AdminBuyersInsightsDetailsWrapper;
