...
import CultivatorPromoSurveyDetails from './CultivatorPromoSurveyDetails/CultivatorPromoSurveyDetails';
import styles from './styles';

const CultivatorPromoSurvey: FC = () => {
...
export default CultivatorPromoSurvey;
