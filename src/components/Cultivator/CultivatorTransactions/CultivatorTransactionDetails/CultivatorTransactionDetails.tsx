...
import BlockchainTable from 'components/Admin/AdminTransactions/AdminTransactionDetails/BlockchainTable/BlockchainTable';
...
const CultivatorTransactionDetails: FC = () => {
...
export default CultivatorTransactionDetails;
