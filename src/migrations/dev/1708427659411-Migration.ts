...
export class Migration1708427659411 implements MigrationInterface {
    name = 'Migration1708427659411'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."survey_status_enum" AS ENUM('New', 'Activated', 'Rejected', 'BuyerConfirmed', 'SurveySent', 'Done')`);
 ...
 `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DELETE FROM "public"."typeorm_metadata" WHERE "type" = $1 AND "name" = $2 AND "schema" = $3`, ["VIEW","company_insight_view","public"]);
        await queryRunner.query(`DROP VIEW "company_insight_view"`);
        await queryRunner.query(`CREATE TYPE "public"."survey_status_enum_old" AS ENUM('Activated', 'BuyerConfirmed', 'Done', 'New', 'Rejected', 'SurvaySent')`);
        await queryRunner.query(`ALTER TABLE "survey" ALTER COLUMN "status" DROP DEFAULT`);
