...
export class Migration1706523534010 implements MigrationInterface {
    name = 'Migration1706523534010'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "survey" ALTER COLUMN "aroma_smells" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "survey" ALTER COLUMN "aroma_smells" SET DEFAULT '{}'`);
 ...
 `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "survey" ALTER COLUMN "aroma_smells" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "survey" ALTER COLUMN "aroma_smells" DROP NOT NULL`);
    }
